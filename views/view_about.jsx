    ...
    return (
      <div className="row">
        <div className="span8 offset2">
          ...
          <p>Qui ad quod referrentur. Ex pri mundi consul aliquip, mea graeci honestatis an. An eam noster legimus suscipit. Error oportere quaerendum pri ad, alii sonet maiestatis ei mea. Pri quidam deleniti ei, per eu errem aliquam, eius melius vocent ne pri. Scribentur philosophia disputationi vix eu, est propriae pertinax id.</p>
          <p>Ornatus inimicus repudiandae has ex, ei aeque iisque has, te sumo libris dissentiunt nec. In ornatus dolorum menandri vix, mei no laudem labores laboramus, nec graeco definitiones reprehendunt no. Invenire interpretaris vim ea. Has atomorum omittantur et, oratio commune ne eum.</p>
        </div>
      </div>
    );
  }
